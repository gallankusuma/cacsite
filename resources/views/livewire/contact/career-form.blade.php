...
<div class="bg-mist">
    <div class="container mx-auto px-4 py-12 max-w-xl">
        <h1 class="text-3xl font-bold text-slate-800 mb-6">Work With Us</h1>
        ...
        <form wire:submit.prevent="submit" class="space-y-4 text-sm">
            <div>
                <label class="text-xs font-medium text-slate-700 block mb-1">Full Name *</label>
            ...
            <div>
                <label class="text-xs font-medium text-slate-700 block mb-1">CV / LinkedIn URL</label>
                <input class="ap-input" type="text" wire:model="cv_url" placeholder="https://...">
            </div>
